...
namespace ahmedabdou
{
    public partial class vendorRegister : System.Web.UI.Page
    {
        ...
        protected void registerto(object sender, EventArgs e)
        {
            ...
            if (fn.Equals("") || ln.Equals("") || user.Equals("") || pass.Equals("") || em.Equals("") || cn.Equals("") || bnc.Equals(""))
            {
            ...
            else
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@company_name", cn));
                cmd.Parameters.Add(new SqlParameter("@bank_acc_no", bnc));
